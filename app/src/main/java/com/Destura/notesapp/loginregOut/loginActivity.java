...
public class loginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mloginemail=findViewById(R.id.inputEmail);
        mloginpassword=findViewById(R.id.inputPassword);
        mlogin=findViewById(R.id.btnLogin);
        mgotoforgotpassword=findViewById(R.id.forgotPassword);
        mgotosignup=findViewById(R.id.gotoRegister);
        ...
        mgotoforgotpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(loginActivity.this, fogotpassword.class));
            }
        });
